...
exe 'vert 4resize ' . ((&columns * 140 + 141) / 282)
argglobal
balt srcs/main.cpp
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((30 * winheight(0) + 18) / 36)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 87 - ((17 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 87
...
silent! normal! zE
let &fdl = &fdl
let s:l = 57 - ((42 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 57
...
silent! normal! zE
let &fdl = &fdl
let s:l = 89 - ((64 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 89
